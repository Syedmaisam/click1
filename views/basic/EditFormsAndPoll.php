...
$ImageArrData=$objBasic->getFormsDetailValue($imgId[1]);
$val=$ImageArrData[0]['Type'];
$pollans=$ImageArrData[0]['PollAnswer'];
$htmlcodd=$ImageArrData[0]['Custom_Html'];
...
{
	$htmls = $_POST['pophtml'];
	$popanswer=$_POST['pollans'];
	if($val=='Forms')
	{
		$htmlcodd=$_POST['Custom_html'];
	}
	else 
	{
		$htmlcodd=null;
	}
	$objBasic->editFormsPollContent($_POST,$imgId[1],$htmls,$popanswer,$htmlcodd);
	$objGenral->standardRedirect(SITE_ROOT_URL.'views/basic/ViewFormsandPolls.php');
}
...
<body class="skin-blue">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			...
			<section class="content-header">
				<h1>
					<i class="fa fa-qrcode"></i> Poll and Forms Messages <small> /Links with polls and forms</small>
				</h1>
				<ol class="breadcrumb">
						...
						<div style="width: 60%; margin: auto;">
							...
							<div class="nav-tabs-custom"
								...
								<div class="tab-content">
									<div class="tab-pane active custurl" id="tab_1">
										<form id="basicForm" class="form-bordered"
											...
											<div class="input-group col-sm-12"
												...
												<button type="submit" name="submit" id="UpdateId"
													class="btn btn-primary mb10" value="create"
													style="width: 100%;">Update</button>
											</div>
											<div class="input-group col-sm-12"
												style="padding-top: 10px; padding-bottom: 10px;">
												<input id="TypePollForm" type="hidden" name="TypePollForm" value="<?php echo $ImageArrData[0]['Type']?>"></input>
												...
												<input id="Custom_html" type="hidden" name="Custom_html" value="<?php echo $ImageArrData[0]['Custom_Html']?>></input>
									...
									<?php if($ImageArrData[0]['Type']=='Polls')
													echo '<div class="col-sm-4" style="margin-top: 10px;">
													<label class=""><label for="msgStyle">Poll answers</label>
													</div>
													<div class="col-sm-8" style="margin-top:10px;">
													
													<textarea rows="3" cols="40" id="ChangePolls" name="ChngPol" style="resize:none;">'.$pollans.'</textarea>
		                                  ...
		                                  else
		                                     {
		                                     	echo '<div class="col-sm-4" style="margin-top: 10px;">
													...
													<textarea rows="3" cols="40" id="ChangeForms" name="ChngForm" style="resize:none;">'.$htmlcodd.'</textarea>
	...
	<?php include_once SOURCE_ROOT."views/basic/editFormPollIncpop.php"; ?>
	...
	$('#UpdateId').on('click',function()
    {
		/* 	 var value=$("#INP_Form").val();
			 $('#INP_Form').attr("value",value);  */
		  	 var pollans=$("#ChangePolls").val();
			 $('#pollans').attr("value",pollans);	
			 var customhtml=$("#ChangeForms").val();
			 $('#Custom_html').attr("value",customhtml);
			 //$('#Custom_html').html(customhtml);					 
	});
