...
<div class="contentpanel">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="panel-btns" style="float:right;">
                ...
                <a data-toggle="modal-csv-export" href="/export?action=campaign-messages-csv&amp;id=125" data-original-title="Expor to CSV" data-placement="bottom" class="btn btn-white btn-xs tooltips"><i class="fa fa-table"></i></a>
            </div><!-- panel-btns -->
                ...
                <?php    foreach ($arr_camp_message as $campData){ ?>
                            ...
                            <td>
                                <div class="btn-group pull-right  mr10">
                                    <a class="btn btn-primary" href="<?php echo SITE_ROOT_URL.'views/campaign/editMessage.php/'.$campData['campaignId'].'/'.$campData['id'];?>">Edit</a>
                                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                                        <span class="caret"></span>
                                        <span class="sr-only">Toggle Dropdown</span>
                                    </button>
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="<?php echo SITE_ROOT_URL.'views/campaign/editMessage.php/'.$campData['campaignId'].'/'.$campData['id'];?>">Edit</a></li>
                              <!--          <li><a href="/campaigns/message/duplicate/1606/125">Duplicate</a></li>
                                        <li><a href="/analytics/messages/1606">Analytics</a></li>-->
                                        <li class="divider"></li>
                                        <li><a href="<?php echo SITE_ROOT_URL.'views/campaign/DeleteMessage.php/'.$campData['id'].'/'.$campData['campaignId'];?>">Delete</a></li>
                                        <li class="divider"></li>
                        <li><a href="<?php echo SITE_ROOT_URL.'views/Analytics/all.php?id='. $campData['id']; ?>" ><i class="fa fa-bar-chart-o"></i>Analytics</a></li>
                                    </ul>
                                </div><!-- btn-group -->
                            </td>
                        </tr>
    ...
    <div class="row text-center">
        <a href="<?php echo SITE_ROOT_URL.'views/campaign/campaignNext.php/'.$campData['campaignId'].'/'.$campData['id'];?>" class="btn btn-primary">Add new message</a>
    </div>
