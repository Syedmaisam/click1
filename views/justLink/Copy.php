...
<div class="contentpanel">
  ...
  <div class="input-group col-sm-12">
   ...
   <small id="linkProfile_req" style="color: red;display: none;"> Required</small>
                 ...
                 <input type="text" value="<?php echo $linkdata['destination_url']; ?>"  class="form-control required urls" id="d_url" name="d_url" aria-required="true" placeholder="e.g. http://example.com">
                ...
                <div  class="input-group col-sm-12">
                 ...
                 <input type="text" value="<?php echo $linkdata['link_url']; ?>" class="form-control required urls" id="ururl" name="source" aria-required="true" placeholder="e.g. http://www.awesomeproduct.com">
