...
<body class="skin-blue">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left" >
		...
		<aside class="right-side">
			...
			<section class="content-header">
				<h1>
					<i class="fa fa-qrcode "></i> Basic <small>Create new basic link</small>
				</h1>
				<ol class="breadcrumb">
						...
						<div style="width: 50%; margin: auto;">
							...
							<div class="nav-tabs-custom"
								...
								<div class="tab-content">
									...
									<!-- 	<form id="basicForm" class="form-bordered" enctype="multipart/form-data" name="basicForm" method="post"	action="<?php //echo $_SERVER['PHP_SELF'];?>"	onsubmit="return createbasicCamp()">  -->
											...
											<div class="input-group col-sm-12"
												...
												<button class="btn btn-primary mb10" value="create"
													style="width: 100%;" onClick="saveBasicData()" >Create new link</button>
											</div>
											<div class="input-group col-sm-12"
												style="padding-top: 10px; padding-bottom: 10px;">
	...
	<?php include_once SOURCE_ROOT."views/basic/incpop.php"; ?>
