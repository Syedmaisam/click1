...
<table width="97%" border="0">
  ...
  <td><label>Layer One Text :</label></td>
   ...
   <tr>
    ...
    <td><input class="color boxcolor" value="66ff00" id="button1_gcolor" onchange="button1_gcolor();"></td>
    <td><label> Subscribe Text :</label></td>
    <td><input type="text" value="" maxlength="14" id="button1_txt" onkeyup="button1_txt();" onblur="button1_txt();"  /></td>
...
function pop_layer_data()
{
    ...
    var button1_txt=$("#ulp-layer-352 .ulp-inherited").text();
    ...
    $("#button4_txt").val(button4_txt);
						...
						function button1_gcolor()
						{
							var button1_bkgcolor="#"+$("#button1_gcolor").val();
						...
						function button1_txt()
						{
							...
							//alert(bgcolor);
							$("#ulp-layer-352 .ulp-inherited span").text(button1_txt);
						}
