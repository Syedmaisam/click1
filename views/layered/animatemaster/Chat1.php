...
#ulp-layer-144, #ulp-layer-144 p, #ulp-layer-144 a, #ulp-layer-144 span, #ulp-layer-144 li, #ulp-layer-144 input, #ulp-layer-144 button, #
 {
    color: #ffffff;
    font-family: "arial",arial;
    font-weight: 400;
...
$txthtml="<div id='popupform' style='position:relative;'><div class='ulp-content' style='width: 550px; height: 410px; margin: 10% auto auto;'>
							<a class='linkanchor' href='http://www.google.com'><div id='ulp-layer-139' class='ulp-layer' style='width: 550px; height: 410px; font-size: 14px; left: 0px; top: 0px; display: block;'><img style='height: 100%;' alt='' src='http://cliks.it/click/city.jpg'></div>
							<div id='ulp-layer-140' class='ulp-layer' style='width: 550px; height: 410px; font-size: 14px; left: 0px; top: 0px; display: block;'></div>
							<div id='ulp-layer-141' class='ulp-layer animated bounceInDown' style='width: 550px; font-size: 24px; left: 0px; top:45px;'>Live Chat</div>
							<div id='ulp-layer-144' class='ulp-layer animated zoomInLeft' style='width: 480px; font-size: 15px; left: 35px; top: 115px; height: 165px;'><textarea disabled='disabled' class='ulp-input' name='ulp-message' placeholder='hey friends..how are you' onfocus='jQuery(this).removeClass('ulp-input-error');' style='border-radius: 6px ! important; font-size:16px!important; padding:12px!important; background:#f9fafe; color:#000; border:1px solid#e0e0e0;'></textarea><div class='ulp-fa-input-table'><div class='ulp-fa-input-cell'></div></div></div>				
		                   <div id='sound'></div>	 
		                    <div id='ulp-layer-146' class='ulp-layer animated slideInDown' style='height: 42px; font-size: 17px; top: 315px; left: 390px; width: 124px;'><a data-loading='PLEASE WAIT!' data-label='SUBSCRIBE NOW!' data-icon='fa-check-square-o' onclick='return ulp_subscribe(this);' class='ulp-submit ulp-inherited' style='padding-left: 6px; background: none repeat scroll 0% 0% rgb(92, 50, 108); border: 1px solid rgb(255, 255, 255);'>&nbsp; CHAT</a></div>
...
<table width="97%" border="0"> 
  ...
  <tr>
    ...
    <td><input type="text" value="" id="layer1_txt" onkeyup="layer1_txt();" onblur="layer1_txt();" maxlength="40" /></td>
  ...
  <tr>
   <td><label>Button Text :</label></td>
    <td><input type="text" value="" id="button1_txt" onkeyup="button1_txt();" onblur="button1_txt();" maxlength="13"  /></td>
    <td><label>Image Url :</label></td>
    <td><input type="text" value="" id="ImageUrl_txt" onkeyup="ImageUrl_txt();" onblur="ImageUrl_txt();"/></td>
    </tr>
   <tr>
   ...
   <tr>
    ...
    <td><input class="color boxcolor" value="66ff00" id="layer2_color" onchange="layer2_color();"></td>
     <td><label>Layer two BackgroundColor :</label></td>
    <td><input class="color boxcolor" value="66ff00" id="layer2_bgcolor" onchange="layer2_bgcolor();"></td>
    </tr>
    <tr>
...
function pop_layer_data()
{
	...
	var layer2_txt=$("#ulp-layer-144").attr('src');//var text=$("#ulp-layer-144 textarea").append(arr.shift());
	
	var imageurl=$("#ulp-layer-139 img").attr('src');
	
	var button1_txt=$("#ulp-layer-146 .ulp-submit").text();
	var txtvalue=$("#ulp-layer-144 textarea").attr('placeholder');
...
var Pathname =  window.location.pathname;
						...
						function ImageUrl_txt()
						{
							var img_txt=$("#ImageUrl_txt").val();
							$("#ulp-layer-139 img").attr('src',img_txt);
						}
						...
						function button1_color()
						{
							...
							$("#ulp-layer-146 .ulp-submit").css("color",fcolor);
						}
						function button1_bkgcolor()
						{
							var button1_bkgcolor="#"+$("#button1_bkgcolor").val();
							$("#ulp-layer-146 .ulp-submit").css('background',button1_bkgcolor);
						}
						function button1_txt()
						{
							var button1_txt=$("#button1_txt").val();
							$("#ulp-layer-146 .ulp-submit").text(button1_txt);
						}
						function Textbox_txt()
						{
							
							var fetch_txt=$("#Textbox_txt").val();
							$("#ulp-layer-144 textarea").html(fetch_txt);
						...
						function layer2_color()
						{
							...
							$("#ulp-layer-144 textarea").css("color",fcolor);
						}
						function layer2_bgcolor()
						{
							var bgcolor="#"+$("#layer2_bgcolor").val();
							//alert(bgcolor);
							$("#ulp-layer-144 textarea").css("background",bgcolor);
						}
	...
	var textval=$("#ulp-layer-144 textarea").attr('placeholder'); 
