...
{
	$profilestat = $objProfile->get_campaign_links($_REQUEST['id']);
...
$days = count($fechas);
$data = 'ga:pageviews,ga:avgTimeOnPage,ga:uniquePageviews,ga:newUsers,ga:entrances';
...
function makehrefDate()
{
	...
	var href = SITE_ROOT_URL+"views/Analytics/campaign_stats_views.php?id="+ids+"&fromDate="+startdate+"&toDate="+enddate;
