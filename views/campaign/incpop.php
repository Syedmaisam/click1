...
<div id="popbasic">
<?php if($arrCampaignData[0]['popData']=="")
{
	?>
  <div class="boxspeech msgbl tstylenorm" id="magic" style="left:0; bottom:0;"><div class="fold"><div class="picture"> <a title="Profile picture" href="#"><img alt="Profile picture" src="<?php echo SITE_ROOT_URL.'images/profile/default.png'?>" style="border-color: rgb(204, 204, 204);"></a> </div>      <div class="message" style="background-color: rgb(255, 255, 255); border-color: rgb(204, 204, 204);" id="pseudoCssId0">        <div class="titler"> <a title="YourProfile Twitter" href="#" class="link" style="color: rgb(49, 51, 55);" id="txtlink">Profile Name</a>          <div id="closeWrapper" style="width: 0px;">            <div id="closeCall"> <a href="#" class="closeCall">x</a> </div>          </div>          <div class="label"> <a href="#"><img  alt="close" id="closebp" src="<?php echo SITE_ROOT_URL."images/close_btn.png"; ?>" onclick="closebpcall();"></a> </div>        </div>        <div class="texter">          <p style="color: rgb(54, 57, 61);"><span id="mktmsg">Your marketing message here</span><a href="http://www.cliks.it" style="color: rgb(255, 255, 255); background-color: rgb(0, 174, 239);" id="linkbgcl">Click here</a></p>        </div>      </div>    </div>    <div style="display: none;" class="discusArea">      <div class="discussHeader" style="background-color: rgb(0, 174, 239);">        <div class="discussTitle">Discussion Title</div>        <div id="discussActionToggle" class="discussAction clicked"></div>      </div>      <div style="display: none; border-left: 1px solid rgb(0, 174, 239); border-right: 1px solid rgb(0, 174, 239);" class="discussContent">        <div id="discussCentral" class="discussBody">          <div class="discussIntroduction">            <p>There are no messages yet, so be the first to participate!</p>          </div>        </div>        <div class="discussSubmit">          <input placeholder="Type here and hit enter to send">        </div>        <div class="discussCopyright"> Powered by <a target="_blank" href="http://cliks.it/">Cliks.it</a> </div>      </div>    </div>  </div>
    <?php 
} 
else 
{
	echo html_entity_decode($arrCampaignData[0]['popData']);
} 
  ?>
</div>
...
$(document).ready(function() {
 ...
 function pbgcolor()
	...
	function msgtxtcampaign()
	{
		var msgt=$("#generatorMessageText").val();
		$("#mktmsg").html(msgt);
	}
	function caltext()
	{
	...
	function caltextcampaign()
	{
		
		var ch=$("#generatorActionText").val();
...
function changeActionLink()
{
	...
	var ch=$("#generatorActionLink").val();
