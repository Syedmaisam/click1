   ...
   <!-- Right side column. Contains the navbar and content of the page -->
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                      <i class="fa fa-desktop"></i> Profile Stats
                        <small>Quick overview of stats of profile</small>
                    </h1>
                    <ol class="breadcrumb">
...
?>
        ...
        <div class="panel panel-default widget-profile" id="profile_<?php echo $data['id']; ?>">
            ...
            <div class="row">
				<div class="col-xs-3 text-center" style="padding:18px; padding-left:30px;"> <img class="widget-profile-img thumbnail" src="<?php echo SITE_ROOT_URL; ?>images/profile/<?php echo $data['profile_image_path']; ?>" alt="80x80" style="width: 100px;"> </div>
...
<!--                        <li><a href="/account/profiles/users/769">User access</a></li>-->
                        <li class="divider"></li>
                        <li><a href="<?php echo SITE_ROOT_URL.'views/Analytics/profile_stats_views.php?id='. $data['id']; ?>" ><i class="fa fa-bar-chart-o"></i>Analytics</a></li>
                        <li class="divider"></li>
