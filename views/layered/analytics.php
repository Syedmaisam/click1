...
$arrLinkData = $objLayered->get_layered_rand($arrUrl[1]);
									...
									<tbody>
										<tr>
											<input id="ids" type="hidden"
												value="<?php echo $arrLinkData[0]['layered_randUrl'];?>">
											<td>Link</td>
											<td>
												<div style="position: relative;">
													<a><?php echo $arrLinkData[0]['layered_randUrl'];?> </a>
										...
										<tr>
											<td>Title</td>
											<td><?php echo $arrLinkData[0]['popup_title'];?></td>
										</tr>
									</tbody>
								</table>
							</div>
...
function makehrefDate()
{
	...
	var href = SITE_ROOT_URL+"views/layered/analytics.php/"+ids+"/"+startdate+"/"+enddate;
