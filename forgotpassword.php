...
<body class="login-page"   style="background-color:<?php echo $colorData[0]['LoginPageBgColor'] ?>">
	...
	<div class="container col-top col-form">
		...
		<div class="row">
			...
			style="background:#fff;color: #3d3d3d;font-size: 2.3em;padding-top:25px; padding-bottom:20px; text-align: left; ">Recover Your Password</p>
		<div class="login-box-body">
			...
			<!--  <a href="#">I forgot my password</a><br> -->
				<button type="submit" class="col-loging btn-block btn-flat"
					style="height: 40px;" onclick="sendpasword()">Recover</button>
