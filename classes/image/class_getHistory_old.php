...
class HistoryClass extends Database
{
	...
	{
		$arrSelectCol = array('randomLink','userId','id','title','contentUrl','profile','imageLocation','imageUrl','yourUrl','popupHeight','popupWidth','popupTiming','created','view','uniqueview');
