...
$arrPopupsName = array('1'=>'Subscribe Form','2'=>'Terms & Conditions','3'=>'Social Email 1','4'=>'Contact Form 1','5'=>'Subscribe Form 2','6'=>'Subscribe Newsletter 1','7'=>'Contact Form 2','8'=>'Report Form 1'
	,'9'=>'Social Email 2','10'=>'Subscribe Newsletter 2','11'=>'Massive Traffic 1','12'=>'Massive Traffic 2','13'=>'Social Email 3','15'=>'Subscribe Form 3','16'=>'Product Overlay','17'=>'Video Overlay','18'=>'Chat1','19'=>'Chat2','20'=>'Chat3','21'=>'Chat4');//'14'=>'Massive Traffic 3'
...
<!-- Text area start -->											
		...
		<label class="label_class">Please enter your html code <small style="color: red;">*</small></label><span style="color:red;display: none;" id="textarea_error">Required</span>
 ...
 <table class="ulp_useroptions">
					<tbody><tr>
						...
						<td width="593">
							...
							<br><em>Get your authorization code <a href="https://auth.aweber.com/1.0/oauth/authorize_app/fd4c9a9d" target="_blank">here</a>. </em>
						</td>
					</tr>
...
<div id="getconstantbox" class="col-sm-12"
	style="display: <?php echo ($arrLayeredData[0]['popup_email_provide']==6)?"block":'none'; ?>; border: 1px solid rgb(204, 204, 204); margin-top: 26px; background: none repeat scroll 0% 0% rgb(248, 248, 248);">
...
<table class="ulp_useroptions">
	<tbody>
		<tr>
			<th>API Key</th>
			<td><input type="text" 
				class="form-control" value="<?php echo $arrpostDetail[0]['constant_api_key']; ?>"
		...
		<tr>
			<th>Access Token</th>
			<td><input type="text" 
				class="form-control"value="<?php echo $arrpostDetail[0]['constant_access_token']; ?>"
...
<div id="iContactBox" class="col-sm-12"
	style="display: <?php echo ($arrLayeredData[0]['popup_email_provide']==7)?"block":'none'; ?>; border: 1px solid rgb(204, 204, 204); margin-top: 26px; background: none repeat scroll 0% 0% rgb(248, 248, 248);">
...
<table class="ulp_useroptions">
	<tbody>
		<tr>
			<th>APP ID:</th>
			<td><input type="text" onChange="ulp_getresponse_handler();"
				class="form-control iContact_appid" value="<?php echo $arrpostDetail[0]['iContact_appId'];?>"
		...
		<tr>
			...
			<td><input type="text" onChange="ulp_getresponse_handler();"
				class="form-control ulp_iContact_user_name" value="<?php echo $arrpostDetail[0]['iContact_user_name'];?>"
		...
		<tr>
			...
			<td><input type="text" onChange="ulp_getresponse_handler();"
				class="form-control ulp_iContact_user_name" value="<?php echo $arrpostDetail[0]['iContact_passwsord'];?>"
