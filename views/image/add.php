...
$objProfilejust = new Profile_Controller();
$arrData = $objProfilejust->get_profile();
...
<div id="linksPopUpAdd" style="z-index: 50000; position: fixed; width: 700px; margin: auto; top: 20%; left: 30%; display: none;"></div>
								...
								<div class="tab-content">
									...
									<div class="tab-pane active custurl" id="tab_1">
										<form id="imageForm" class="form-bordered"
											...
											action="<?php echo SITE_ROOT_URL. 'ajax/image/ajax_add_image.php'?>"
											...
											<div class="input-group col-sm-12">
												...
												&nbsp;&nbsp;&nbsp; <label id="Err_contentUrl"
													...
													id="inp_contentUrl" type="text" value=""
											...
											<div id="imagePreview" style="height: 100px;width: 129px;">
											<span class="clo_1" style="display: none;"><i class="fa fa-fw fa-times-circle-o" id="image_crossButton"  onclick="onclick_CrossButton()"></i></span>
											</div>
											</div>
	...
	<option selected="selected" value="0">Center Screen</option>
...
<label for="generatorSource">Disable Overlay</label> <span><input
	type="checkbox" id="check" name="check" style="opacity:1!important;"></span></div>
...
<script type="text/javascript" src="<?php echo SITE_ROOT_URL;?>js/jquery.form.js"></script>
<script type="text/javascript">
$(document).ready(function(){

	$.ajax({
		url:location.protocol + '//' + location.host+"/click/ajax/image/ajax_getHistory.php",
		type:"post",
		 data: {
			    submit: "submit"
	 	    	 ...
	 	    	 var options = {success:function(response){
	 	 	      ...
	 	 	      if(istatus == true)
	 	 	      {
	 	 	    	$("#linksPopUpAdd").html(response);
	 				   $("#linksPopUpAdd").css('display', 'block');
$(".loader_popup").hide();
	 				  $(".blackscreen").show();
	 	 	      }
