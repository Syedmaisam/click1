...
$path=$arrData[0]['profile_image_path'];
$arrUserCampaignData = $objCampaign->get_user_campaigns($arrUrl[3]);
/* var_dump($arrData);
exit; */
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<input type="hidden" name="id" id="ImageId" value="<?php echo $arrUrl[3]; ?>"/>
                    </ol>
                </section>
            ...
            <div class="panel-body">
                ...
                <div style="margin-left:17.8%;"><small id="campaignSel_req" style="color: red;display: none;"> Required</small></div>
                    ...
                    <div class="col-sm-10">
                                               ...
                                               <select class="form-control input-sm valid" id="linkProfile" name="profile" aria-required="true" aria-invalid="false" onChange="changeProfileonPopUp();" >
                        ...
                        <div class="col-sm-10">
                            ...
                            <select class="form-control input-sm" id="linkCampaign" name="campaignId">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="" onKeyUp="msgtxtcampaign();" maxlength="255" placeholder="e.g. We offer an awesome product" id="generatorMessageText" class="form-control" required name="messageText" aria-required="true">                    
                        </div>
                                    </div>
                ...
                <div style="margin-left:17.8%;"><small id="campaignAction_req" style="color: red;display: none;"> Required</small> </div>
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="<?php echo $arrCampaignData[0]['actionText']; ?>" onKeyUp="caltextcampaign();" maxlength="32" placeholder="e.g. Try it now" id="generatorActionText" class="form-control" required name="actionText" aria-required="true">                    </div>
                                    </div>
                ...
                <div style="margin-left:17.8%;"><small id="campaignActionLink_req" style="color: red;display: none;"> Required</small> </div>
                   <div style="margin-left:17.8%;"><small id="ValidateLinkUrl" style="color: red;display: none;">InValid Url</small> </div>
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="<?php echo $arrCampaignData[0]['actionLink'];?>"onkeyup="changeActionLink()" maxlength="455" placeholder="e.g. http://www.mycompany.com/signup" id="generatorActionLink" class="form-control" required name="actionLink" aria-required="true">                    </div>
                                    </div>
            </div>
        </div>      
...
<input class="color boxcolor" value="66ff00" id="linkbgcolor" onChange=" linkbg();">    </div>
 ...
 <div class="row text-center mb100">
        <button type="submit" class="btn btn-primary" onClick="updateCampaignData();">Save Campaign</button>
...
$(document).ready(function(){
	...
	$("#generatorActionText").val($("#linkbgcl").html());
	$("#generatorActionLink").val($("#linkbgcl").attr("href"));
	$("#generatorMessageText").val($("#mktmsg").html());
...
function changeProfileonPopUp()
{
	...
	$("#campaignMessage_req").hide();
	$("#campaignAction_req").hide();
	$("#campaignActionLink_req").hide();
	var profId = $('#linkProfile option:selected').html();
	var profIdval = $('#linkProfile option:selected').val();
    var Image=$()
    $("#id").val(profIdval);
	...
	$.ajax({
		...
		success: function(response) {
			...
			var imagepath=img[0];
			var remaining=img[1];
			var camp=remaining.split('%');
			var campaignName=camp[1];
		    var path=SITE_ROOT_URL+"images/profile/"+imagepath;
			$(".picture a img").attr("src",path);
			$('#linkCampaign').html(campaignName);
