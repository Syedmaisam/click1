...
$days = count($fechas);
$data = 'ga:pageviews,ga:visits,ga:avgTimeOnPage,ga:uniquePageviews,ga:entrances';
								...
								<table class="table">
									<tbody>
										...
										<tr>
											<td>Image Url</td>
											<td><a target="_blank"
												href="<?php echo ($arrLinkData[0]['imageLocation']!='')?SITE_ROOT_URL.'images/basic/'.$arrLinkData[0]['imageLocation']:$arrLinkData[0]['imageUrl'];?>"><?php echo ($arrLinkData[0]['imageLocation']!='')?SITE_ROOT_URL.'images/basic/'.$arrLinkData[0]['imageLocation']:$arrLinkData[0]['imageUrl'];?>
											</a></td>
										</tr>
										<tr>
											<td>Title</td>
					...
					<div class="panel panel-default panel-stat-header">
						...
						<form id="dateForm" class="form-bordered"
							...
							<div class="panel-body">
								...
								<div class="input-group date">
									<input type="text" value="<?php echo date("Y-m-d"); ?>" id="datepickerend"
...
function makehrefDate()
{
	...
	var href = SITE_ROOT_URL+"views/image/analytics.php/"+ids+"/"+startdate+"/"+enddate;
