...
<table width="97%" border="0">
   ...
   <tr>
    ...
    <td><textarea type="text" value="" id="layer2_txt" onkeyup="layer2_txt();" onblur="layer2_txt();" maxlength="75"></textarea></td>
   ...
   <tr>
    ...
    <td><input type="text" value="" id="button1_txt" maxlength="40" onkeyup="button1_txt();" onblur="button1_txt();" /></td>
   ...
   <tr>
    ...
    <td><input type="text" value="" onkeyup="layer4_txt();" onblur="layer4_txt();" maxlength="85" id="layer4_txt" /></td>
