 ...
 <div class="boxspeech msgbl tstylenorm" id="magic" style="left:0; bottom:0;">
    <div class="fold">
      ...
      <div class="message" style="background-color: rgb(255, 255, 255); border-color: rgb(204, 204, 204);" id="pseudoCssId0">
        ...
        <div class="texter">
          <p style="color: rgb(54, 57, 61);"><span id="mktmsg">Your marketing message here<br><input id="INP_Form" type="text" placeholder="FirstName" value=""/>&nbsp;<input id="INP_EmailForm" type="text" placeholder="Email_Id" value=""/></span><a href="#" style="color: rgb(255, 255, 255); background-color: rgb(0, 174, 239);" id="linkbgcl">Submit</a></p>
        </div>
    ...
    <div style="display: none;" class="discusArea">
      ...
      <div style="display: none; border-left: 1px solid rgb(0, 174, 239); border-right: 1px solid rgb(0, 174, 239);" class="discussContent">
        ...
        <div class="discussCopyright"> Powered by <a target="_blank" href="http://ope.nr">Openr</a> </div>
      </div>
    </div>
  </div>
</div>
...
var asd = $("#mktmsg").html();
var splitmsg=asd.split('<');


	//$("#messsage").val(splitmsg[0]);
 ...
 function pbgcolor()
	...
	function msgtxt()
	{
		...
		$("#mktmsg").html(msgt);
		$("#mktmsg").append('<br>');
		$("#mktmsg").append('<input type="text" value="" placeholder="FirstName" id="INP_Form">');
		$("#mktmsg").append('&nbsp;<input type="text" value="" placeholder="Email_Id" id="INP_EmailForm">');
