	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			...
			<section class="content-header">
				<h1>
					<i class="fa fa-qrcode"></i> Polls and Forms Messages <small> / Links with polls and forms</small>
				</h1>
				<ol class="breadcrumb">
				...
				<div class="contentpanel">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<!-- panel-btns -->
							<h3 class="panel-title">Polls and forms results</h3>
							<p>Below you can see all polls and forms you've created previously</p>
						</div>
						<div class="panel-body">
							...
							<div class="row text-center mb30">
							 -->
							 	<a class="btn btn-primary" href="Polls.php"><i
									class="fa fa-link"></i> Create new poll</a>
							<!-- </div>
							<div class="row text-center mb30"> -->
                                         
								<a class="btn btn-primary" href="Forms.php" style="margin-left: 30px;"><i
									class="fa fa-link"></i> Create new form</a>
							</div>
