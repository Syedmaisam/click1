...
$txthtml="<div id='popupform' style='position:relative;'><div class='ulp-content' style='width: 595px; height: 397px; margin: 10% auto auto;'>
...
<li>Fitatos vutario lacus quis arcup delis</li>
							...
							<div id='ulp-layer-191' class='ulp-layer animated zoomInDown' style='width: 258px; height: 37px; font-size: 14px; left: 19px; top: 287px;'><a data-loading='Loading...' data-label='Subscribe' data-icon='fa-pencil-square-o' onclick='return ulp_subscribe(this);' class='ulp-submit'><i class='fa fa-pencil-square-o'></i>&nbsp; <span id='spnid'>Subscribe</span></a></div>
							<div id='ulp-layer-192' class='ulp-layer' style='width: 39px; height: 19px; font-size: 23px; left: 555px; top: -29px;'><a onclick='return ulp_self_close();' href='#'>x</a></div>
...
?>
 ...
 <table width="108%" border="0">
  <tr>
    ...
    <td><input type="text" value="" id="header_txt" onkeyup="header_txt();" onblur="header_txt();" maxlength="30" /></td>
   
  </tr>
 
   
  <tr>
    <td><label>Content One Color :</label></td>
    <td><input class="color boxcolor" value="66ff00" id="layer1_color" onchange="layer1_color();"></td>
    <td><label>Content One Text :</label></td>
    <td><textarea type="text" value="" id="layer1_txt" onkeyup="layer1_txt();" onblur="layer1_txt();" maxlength="30" ></textarea></td>
    
  </tr>
  
   <tr>
    <td><label>Content Two Color :</label></td>
    <td><input class="color boxcolor" value="66ff00" id="layer2_color" onchange="layer2_color();"></td>
    <td><label>Content Two Text :</label></td>
    <td><textarea type="text" value="" id="layer2_txt" onkeyup="layer2_txt();" onblur="layer2_txt();" maxlength="30" ></textarea></td>
   ...
   <td><label>Placeholder Two text :</label></td>
    ...
    <tr>
    <td><label>Content Three Color :</label></td>
    <td><input class="color boxcolor" value="66ff00" id="layer3_color" onchange="layer3_color();"></td>
    <td><label>Content Three Text :</label></td>
    <td><textarea type="text" value="" id="layer3_txt" onkeyup="layer3_txt();" onblur="layer3_txt();" maxlength="30" ></textarea></td>
...
<tr>
<td><label>Header Text Color :</label></td>
   <td><input class="color boxcolor" value="66ff00" id="headertxtcolor" onchange="headertxtcolor();"></td>
</tr>
...
{
	var header_txt=$("#ulp-layer-185").html();
	var layer1_txt=$("#ulp-layer-186").html();
	var layer2_txt=$("#ulp-layer-187 .ulp-901").html();
	var layer3_txt=$("#ulp-layer-193").html();
	var placeholder1_txt=$("#ulp-layer-189 .ulp-input").attr('placeholder');
	var placeholder2_txt=$("#ulp-layer-190 .ulp-input").attr('placeholder');
	
	var button1_txt=$("#ulp-layer-191 .ulp-submit").attr('data-label');
	...
	$("#button1_txt").val(button1_txt);
					    ...
					    function header_bg()
						{
							...
							//alert(bgcolor);
							$("#ulp-layer-184").css("background-color",bkgcolor);
						}
					    function popup_bg()
						{
						    var popbgcolor="#"+$("#popbgcolor").val();
							//alert(bgcolor);
							$("#ulp-layer-188").css("background-color",popbgcolor);
						}
						function header_txt()
						{
							var header_txt=$("#header_txt").val();
							//alert(bgcolor);
							$("#ulp-layer-185").html(header_txt);
						}
                                                function headertxtcolor()
                                                {
                                                 var fcolor="#"+$("#headertxtcolor").val();
                                                 $("#ulp-layer-185").css("color",fcolor);
                                                }
						...
						function layer1_color()
						{
							...
							//alert(bgcolor);
							$("#ulp-layer-186").css("color",fcolor);
						}
						function layer1_txt()
						{
							var layer1_txt=$("#layer1_txt").val();
							//alert(bgcolor);
							$("#ulp-layer-186").html(layer1_txt);
						}
						...
						function layer2_color()
						{
							...
							//alert(bgcolor);
							$("#ulp-layer-187 .ulp-901 li").css("color",fcolor);
						}
						function layer2_txt()
						{
							var layer2_txt=$("#layer2_txt").val();
							//alert(bgcolor);
							$("#ulp-layer-187 .ulp-901 ").html(layer2_txt);
						}
						function layer3_color()
						{
							var fcolor="#"+$("#layer3_color").val();
							//alert(bgcolor);
							$("#ulp-layer-193").css("color",fcolor);
						}
						function layer3_txt()
						{
							var layer3_txt=$("#layer3_txt").val();
							//alert(bgcolor);
							$("#ulp-layer-193").html(layer3_txt);
						}
						...
						function placeholder1_txt()
						{
							...
							//alert(bgcolor);
							$("#ulp-layer-189 .ulp-input").attr('placeholder',placeholder1_txt);
						}
						...
						function label2_color()
						{
							...
							//alert(bgcolor);
							$("#ulp-layer-190").css("color",fcolor);
						}
						...
						function placeholder2_txt()
						{
							...
							//alert(bgcolor);
							$("#ulp-layer-190 .ulp-input").attr('placeholder',placeholder2_txt);
						}
						...
						function button1_color()
						{
							...
							//alert(bgcolor);
							$("#ulp-layer-191 .ulp-submit").css("color",fcolor);
						...
						function button1_bkgcolor()
						{
							...
							$("#ulp-layer-191 .ulp-submit").css('background',button1_bkgcolor);
						}
						function button1_txt()
						{
							var button1_txt=$("#button1_txt").val();
							//alert(bgcolor);
							$("#ulp-layer-191 .ulp-submit span").html(button1_txt);
						}
