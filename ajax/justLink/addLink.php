...
{
	$msg = $objJustLink->add_link($_POST);
}

$objDomain = new Domain_Controller();
$arrDomianData = $objDomain->get_domain();

$domainName = ($arrDomianData[0]['domain_status']==1)?"http://".$arrDomianData[0]['domain_name']."/".$msg[0]['randUrl']:SITE_ROOT_URL.$msg[0]['randUrl'];
...
<div class="modal-content">
	...
	<div style="display: table;" class="modal-body">
		...
		<div class="col-md-8">
			<b id="sharetitle"><?php echo $msg[0]['link_name']; ?> </b><br>
		...
		<div class="col-md-12">			
			...
			<div class="col-md-6">
				...
				<a href="<?php echo SITE_ROOT_URL.'views/justLink/add.php';?>"	class="btn btn-primary button-left"><i class="fa fa-plus"></i> <span>New</span>
				</a>
...
function vkShareBox()
 ...
 function closePopUp()
 {
	 ...
	 $(".blackscreen").hide();
	 $(".loader_popup").hide();
	 window.location.assign("<?php echo SITE_ROOT_URL."views/justLink/index.php";?>")
 }
