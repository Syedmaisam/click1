...
$addurl = $arrUrl[1];
$jaihanuman = "ga:pagePath==/" . ANALYTICS_FOLDER . "/{$addurl}";
//echo $newaddurl;
...
try{
	...
	//$jaihanuman = "ga:pagePath==/googleana/view.php";
...
//var_dump($Countryreport->getRows());
//exit;
										...
										<tr>
											...
											<td>
												<div style="position: relative;">
													<a href="<?php echo SITE_ROOT_URL; echo $arrLinkData[0]['randomlink']; ?>" target="_blank"><?php echo $arrLinkData[0]['randomlink'];?> </a> &ndash;
													<a data-href="http://openr.co/2M4"
...
function makehrefDate()
{
	...
	var href = SITE_ROOT_URL+"views/basic/analytics.php/"+ids+"/"+startdate+"/"+enddate;
