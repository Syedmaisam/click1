...
$value=$_POST['custom_html'];


if(isset($_POST['submit']) && $_POST['submit']=='submit')
{
	$msg=$objBasic->saveFormsTab($_POST,$_FILES, $_POST['pophtml'],$_POST['custom_html']);
	...
	<div style="display: table;" class="modal-body">
		...
		<div class="col-md-12">			
			...
			<div class="col-md-6">
				...
				<a href="<?php echo SITE_ROOT_URL.'views/basic/Forms.php';?>"	class="btn btn-primary button-left"><i class="fa fa-plus"></i> <span>New</span>
				</a>
...
function openPin()
{
 ...
 function closePopUp()
 {
	 ...
	 $(".blackscreen").hide();
	 $(".loader_popup").hide();
	 window.location.assign("<?php echo SITE_ROOT_URL."views/basic/ViewFormsandPolls.php";?>")
 }
