...
{
	$msg= $objBasic->savePollTab($_POST,$_FILES, $_POST['pophtml'],$_POST['pollans']);
}
	...
	<div style="display: table;" class="modal-body">
		...
		<div class="col-md-12">			
			...
			<div class="col-md-6">
				...
				<a href="<?php echo SITE_ROOT_URL.'views/basic/Polls.php';?>"	class="btn btn-primary button-left"><i class="fa fa-plus"></i> <span>New</span>
				</a>
