...
<div class="alert alert-success alert-dismissable col-sm-6" style="left: 20%;display:block;">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php  echo $objJustLink->getTimes($arrDomainData[0]["created_date"]); ?></td>
						<td><small><b>ns1.inspiredsoft.com</b></small><br/><small><b>ns2.inspiredsoft.com</b></small></td>
...
<!-- Start model popup -->
<div id="click_popup" class="clicks-boxpopup" style="z-index: 99999;">
  <header> <a style="cursor: pointer;" class="clicks_close close" title="Close Popup"><img src="<?php echo SITE_ROOT_URL; ?>images/close.png"/></a>
  ...
  <div class="modal-body">
    ...
    <div class="row">
    			...
    			<div class="form-group col-sm-12 class_error" style="float: left;margin-left: 2%;">
                 ...
                 <div class="box-footer col-sm-12" style="margin-top: 1.6%">
