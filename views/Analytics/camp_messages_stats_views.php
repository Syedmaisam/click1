...
{
	$profilestat = $objProfile->get_campaign_msg_links($_REQUEST['id']);
...
function makehrefDate()
{
	...
	var href = SITE_ROOT_URL+"views/Analytics/camp_messages_stats_views.php?id="+ids+"&fromDate="+startdate+"&toDate="+enddate;
