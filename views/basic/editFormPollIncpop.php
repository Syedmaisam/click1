...
<div id="popbasic">
  <div class="boxspeech msgbl tstylenorm" id="magic" style="left:0; bottom:0;">
    <div class="fold">
      <div class="picture"> <a title="Profile picture" href="#"><img alt="Profile picture" src="<?php echo SITE_ROOT_URL.'images/profile/default.png'?>" style="border-color: rgb(204, 204, 204);"></a> </div>
 ...
 function pbgcolor()
	...
	function msgtxt()
	{
		...
		if(typeval=='Forms')
		{
			...
			$("#mktmsg").append('&nbsp;<input id="INP_EmailForm" placeholder="EmailId" type="text" value=""/>');
		}
		else
		{
