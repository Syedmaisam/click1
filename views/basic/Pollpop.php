 ...
 <div class="boxspeech msgbl tstylenorm" id="magic" style="left:0; bottom:0;">
    <div class="fold">
      ...
      <div class="message" style="background-color: rgb(255, 255, 255); border-color: rgb(204, 204, 204);" id="pseudoCssId0">
        ...
        <div class="texter">
          <p style="color: rgb(54, 57, 61);"><span id="mktmsg">Your marketing message here<select id="questionsList"><option>Please choose one of answers</option></select></span><a href="#" style="color: rgb(255, 255, 255); background-color: rgb(0, 174, 239);" id="linkbgcl">Submit</a></p>
        </div>
 ...
 function pbgcolor()
	...
	function msgtxt()
	{
		var msgt=$("#messsage").val();
                 if(msgt=='')
	         {
		  msgt = 'Your marketing message here ';
		 }
		$("#mktmsg").html(msgt);
