...
value</small></span></label> <input type="text" value=""
	...
	value="" class="form-control required" id="linkurl" name="linkurl"
	aria-required="true" placeholder="Enter Link URL eg: http://www.awesomeproduct.com/"></div>
...
<div class="input-group col-sm-6" style="float: left; margin-top: 15px;">
<label for="generatorSource">Email Provider<small style="color: red;">*</small></label><small id="layeredEmail_req"
	style="color: red; display: none;"> Required</small>                 
...
<option value="4">Active Campaign</option>
<option value="5">MailerLite</option>

</select> </div>
 <!-- Get Response --> 
 <div id="getResponseBox" class="col-sm-12" style="display:none; border: 1px solid rgb(204, 204, 204); margin-top: 26px; background: none repeat scroll 0% 0% rgb(248, 248, 248);">
 ...
 <table class="ulp_useroptions">
	...
	style="color: red; display: none;"> Required</small> </th>
						<td>
							<input type="text" onChange="ulp_getresponse_handler();" class="form-control ulp_getresponse_api_key" value="" name="ulp_getresponse_api_key" id="ulp_getresponse_api_key">
	...
	style="color: red; display: none;"> Required</small> </th> 
						<td>
							<input type="text" class="widefat form-control" value="" name="ulp_getresponse_campaign_id" id="ulp_getresponse_campaign_id">
						<br><em> 	
Enter your List ID. You can get List ID fromEnter your List ID. You can get List ID from <a style="cursor: pointer;" class="getresponsepopup">this table</a>. </em>
  ...
  <!-- Aweber Account --> 
 <div id="getAweberBox" class="col-sm-12" style="display:none; border: 1px solid rgb(204, 204, 204); margin-top: 26px; background: none repeat scroll 0% 0% rgb(248, 248, 248);">
 ...
 <table class="ulp_useroptions">
					...
					<tr>
						<th>List ID</th>
						<td>
							<input type="text" class="widefat form-control" value="" name="ulp_mailerlite_campaign_id" id="ulp_getresponse__awaber_campaign_id">
						<br>
  ...
  <!-- Mailer Lite --> 
 <div id="getMailerliteBox" class="col-sm-12" style="display:none; border: 1px solid rgb(204, 204, 204); margin-top: 26px; background: none repeat scroll 0% 0% rgb(248, 248, 248);">
 ...
 <table class="ulp_useroptions">
					...
					<tr>
						<th>API Key:</th>
						<td>
							<input type="text" onChange="ulp_getresponse_handler();" class="form-control ulp_getresponse_api_key" value="" name="ulp_getresponse_api_key" id="ulp_getresponse_api_key_mailer">
					...
					<tr>
						<th>List ID</th>
						<td>
							<input type="text" class="widefat form-control" value="" name="ulp_mailerlite_campaign_id" id="ulp_getresponse__mailer_campaign_id">
						<br>
						<em>Enter your List ID. You can get List ID from<em>Enter your List ID. You can get List ID from <a title="Available Lists" id="ulp_mailerlite_lists" class="getresponsepopup" style="cursor: pointer;">this table</a>.</em>
  ...
  <!-- MailChimp --> 
 <div id="getmailchimpBox" class="col-sm-12" style="display:none; border: 1px solid rgb(204, 204, 204); margin-top: 26px; background: none repeat scroll 0% 0% rgb(248, 248, 248);">
 ...
 <table class="ulp_useroptions">
					...
					<tr>
						<th>API Key:</th>
						<td>
							<input type="text" onChange="ulp_getresponse_handler();" class="form-control ulp_getresponse_api_key" value="" name="ulp_getresponse_api_key" id="ulp_getresponse_api_key_mailchimp">
							<br><em>Enter your Mailchimp API Key. You can get your API Key <a target="_blank" href="https://apidocs.mailchimp.com/">Developer API page</a>.</em>
						</td>
					</tr>
					<tr>
						<th>List ID</th>
						<td>
							<input type="text" class="widefat form-control" value="" name="ulp_mailerlite_campaign_id" id="ulp_getresponse__mailchimp_campaign_id">
						<br>
