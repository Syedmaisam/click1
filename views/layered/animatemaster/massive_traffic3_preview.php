...
<div id='popupform_preview' style="display:none;"><div class="ulp-content" style="width: 700px; height: 400px; margin:auto;position:fixed; left:30%; top:15%;">
...
<li>Dualo fitemus lacus quis preambul bela</li>
							...
							<div id="ulp-layer-228" class="ulp-layer animated fadeInDownBig" style="width: 40px; height: 20px; font-size: 24px; left: 640px; top: -30px;"><a onclick="return ulp_self_close();" href="#">×</a></div>
						</div>
