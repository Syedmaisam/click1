...
$msg =$objImage->saveImageTab($_POST,$_FILES);
//var_dump($msg);
...
<div class="modal-content">
	...
	<div style="display: table;" class="modal-body">
		...
		<div class="col-md-12">
			...
			<div class="col-md-6">
				<span class="input-group-btn" style="text-align: right;"> <a
					href="#" target="_blank"
					class="link-copy-btn btn btn-primary mr10 button-right"
					id="copy-dynamic"
					data_tip="<?php echo $domainName;?>"
					type="button" data-href="#"><i class="fa fa-copy"></i> <span>Copy</span>
				</a> <a
					href="<?php echo $domainName; ?>"
					target="_blank" class="btn btn-primary button-left"><i
						class="fa fa-eye"></i> <span>View</span> </a> <a
					href="<?php echo SITE_ROOT_URL.'views/image/add.php';?>"
					class="btn btn-primary button-left"><i class="fa fa-plus"></i> <span>New</span>
				</a>
			...
			<div class="col-md-3" id="twittershare">
				<div
					...
					<a
						...
						data-text="<?php echo $_POST['message'] ?>"
...
function vkShareBox()
 ...
 function closePopUp()
 {
	 ...
	 $(".blackscreen").hide();
	 $(".loader_popup").hide();
	 window.location.assign("<?php echo SITE_ROOT_URL."views/image/index.php";?>")
 }
