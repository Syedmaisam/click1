...
{
	$msg = $objLayered->add_layered($_POST);
}
$objDomain = new Domain_Controller();
$arrDomianData = $objDomain->get_domain();

$domainName = ($arrDomianData[0]['domain_status']==1)?"http://".$arrDomianData[0]['domain_name']."/".$msg[0]['layered_randUrl']:SITE_ROOT_URL.$msg[0]['layered_randUrl'];
...
<div class="modal-content">
	...
	<div style="display: table;" class="modal-body">
		...
		<div class="col-md-8">
			<b id="sharetitle"><?php echo $msg[0]['popup_title']; ?> </b><br>
		...
		<div class="col-md-12">			
			...
			<div class="col-md-6">
				...
				<a href="<?php echo SITE_ROOT_URL.'views/layered/add.php';?>"	class="btn btn-primary button-left"><i class="fa fa-plus"></i> <span>New</span>
				</a>
...
function vkShareBox()
 ...
 function closePopUp()
 {
	 ...
	 $(".blackscreen").hide();
	 $(".loader_popup").hide();
	 window.location.assign("<?php echo SITE_ROOT_URL."views/layered/index.php";?>")
 }
