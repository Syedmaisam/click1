...
try {
	...
	$report = $ga->getReport(
			...
			array('dimensions'=>urlencode('ga:date'),
					...
					'filters'=>urlencode('ga:pagePath==/click/'.$ImageArrData[0]['randomlink']),
					'sort'=>'ga:date'
			)
	);
	...
	$Countryreport = $ga->getReport(
			...
			array('dimensions'=>urlencode('ga:date,ga:country'),
					'metrics'=>urlencode('ga:pageviews'),'filters'=>urlencode('ga:pagePath==/click/'.$ImageArrData[0]['randomlink']),
					'sort'=>'ga:date'
			)
	);
