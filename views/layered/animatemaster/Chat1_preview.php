...
<div id='popupform_preview' style="display:none;"><div class="ulp-content" style="z-index:99999;width: 550px; height: 410px; margin:auto;position:fixed; left:28%; top:15%;">
							<div id="ulp-layer-139" class="ulp-layer" style="width: 550px; height: 410px; font-size: 14px; left: 0px; top: 0px; display: block;"><img alt="" src="https://layeredpopups.com/layered-popups/images/default/city.jpg"></div>
							...
							<div id="ulp-layer-144" class="ulp-layer animated zoomInLeft" style="width: 480px; font-size: 15px; left: 35px; top: 115px; height: 165px;"><textarea disabled='disabled' id="prview_textarea" class="ulp-input" name="ulp-message" placeholder="" onfocus="jQuery(this).removeClass('ulp-input-error');" style="border-radius: 6px ! important; background:#f9fafe; color:#000; font-size:16px!important; padding:12px!important; border:1px solid#e0e0e0;"></textarea><div class="ulp-fa-input-table"><div class="ulp-fa-input-cell"></div></div></div>
							...
							<div id="ulp-layer-148" class="ulp-layer" style="width: 32px; height: 32px; font-size: 32px; left: 518px; top: 0px;  background:rgb(51, 51, 51);"><a onclick="return ulp_self_close();" href="#">×</a></div>
						</div>
...
var text= "hey friends..how are you.";
var arr=text.split("");
var looptimer;
audio=new Audio("<?php echo SITE_ROOT_URL.'views/layered/' ?>animatemaster/Chat Welcome Alert 2.mp3");
		audio.play();
function frameLooper()
{
	...
	{
		value=arr.shift();
		//document.getElementById("ulp-layer-144 .ulp-input").innerHTML+=arr.shift();
