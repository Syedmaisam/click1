...
iContactApi::getInstance()->setConfig(array(
	'appId'       => '3cA5Epvsg27Luz3WlaNhRrOWLLkZZfnx', 
	'apiPassword' => 'myapp007', 
	'apiUsername' => 'maneesh.devloper@gmail.com'
));
// Store the singleton
...
try {
	...
	// Grab all contacts
	$ListData = $oiContact->getLists();
	$campData = $oiContact->getCampaigns();
	$conTact = $oiContact->getContacts();
	$addContact = $oiContact->addContact('man@man.com', null, null, 'Joe', 'Shmoe', null, '123 Somewhere Ln', 'Apt 12', 'Somewhere', 'NW', '12345', '123-456-7890', '123-456-7890', null);
	//var_dump($oiContact->subscribeContactToList($addContact->contactId,22251,'normal'));
	//var_dump($oiContact->getWarnings());
	echo "<pre>";
	var_dump($campData);exit;
