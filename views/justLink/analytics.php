									...
									<tbody>
										<tr>
											<input id="ids" type="hidden"
												value="<?php echo $arrLinkData[0]['randUrl'];?>">
											<td>Link</td>
											<td>
												<div style="position: relative;">
													<a><?php echo $arrLinkData[0]['randUrl'];?> </a>
										...
										<tr>
											...
											<td><a target="_blank"
												href="<?php echo $arrLinkData[0]['destination_url'];?>"><?php echo $arrLinkData[0]['destination_url'];?>
											</a></td>
										</tr>
										<tr>
											<td>Link Url</td>
											<td><a target="_blank"
												href="<?php echo $arrLinkData[0]['link_url'];?>"><?php echo $arrLinkData[0]['link_url'];?>
											</a></td>
										</tr>
										<tr>
											<td>Title</td>
											<td><?php echo $arrLinkData[0]['link_name'];?></td>
										</tr>
									</tbody>
								</table>
							</div>
...
function makehrefDate()
{
	...
	var href = SITE_ROOT_URL+"views/justLink/analytics.php/"+ids+"/"+startdate+"/"+enddate;
