...
$txthtml="<div id='popupform' style='position:relative;'><div class='ulp-content ' style='width: 442px; height: 442px; margin: 10% auto auto;'>
...
Auctor mauris, rhoncus montes arcu auctor augue lundium, elit velit quis scelerisque tempor penatibus! Sed pellentesque adipiscing adipiscing! Auctor mid? Et, lorem! Ultricies, massa ut rhoncus elementum risus magna! Nunc magna ac. Amet, ridiculus elementum! Porttitor enim integer enim, dignissim sagittis, urna natoque, rhoncus, vel! Montes risus, egestas integer dictumst augue vut et. Cursus! Nec? Montes, porttitor in diam? Non magnis et etiam! Nisi rhoncus nisi mattis. Non, ac, turpis ut, etiam penatibus urna, rhoncus scelerisque. Magna proin penatibus montes adipiscing amet facilisis magnis cras turpis nec integer dictumst? Auctor enim ridiculus enim vut? Pulvinar? Lundium tristique in turpis, in platea in a scelerisque turpis eros a! Risus ridiculus tempor in, lectus aliquam ultricies, in! Ut etiam aliquam enim.</div>
							...
							<div id='ulp-layer-371' class='ulp-layer animated slideInLeft' style='width: 147px; height: 36px; font-size: 12px; left: 57px; top: 384px;'><a onclick='return ulp_self_close();' data-icon='fa-check' class='ulp-link-button ulp-link-button-red' href='#'><i class='fa fa-check'></i>&nbsp;<span id='spnid'> No, I don't agree.</span></a></div>
...
<table border="0" width="96%">
  ...
  <tr>
    ...
    <td><input type="text" value="" id="layer1_txt" onkeyup="layer1_txt();" onblur="layer1_txt();" maxlength="50"  /></td>
   ...
   <tr>
    ...
    <td><textarea id="layer2_txt" onkeyup="layer2_txt();" onblur="layer2_txt();"></textarea></td>
    ...
    <td><label>Button Background Color1 :</label></td>
    <td><input class="color boxcolor" value="66ff00" id="button1_bkgcolor" onchange="button1_bkgcolor();"></td>

    </tr>
   
    <tr>
    <td><label>Button Color2:</label></td>
    <td><input class="color boxcolor" value="66ff00" id="button2_color" onchange="button2_color();"></td>
    <td><label>Button Background Color2 :</label></td>
    <td><input class="color boxcolor" value="66ff00" id="button2_bkgcolor" onchange="button2_bkgcolor();"></td>

   </tr>

 <tr>
    <td><label>Button Text1 :</label></td>
    <td><input type="text" value="" id="button1_txt" onkeyup="button1_txt();" onblur="button1_txt();"  /></td>
    <td><label>Button Text2 :</label></td>
    <td><input type="text" value="" id="button2_txt" onkeyup="button2_txt();" onblur="button2_txt();"/></td>
   </tr>
  
 <tr>
    <td><label>Not Agree Destination URL</label></td>
    <td><input type="text" value="" maxlength="90" id="buttonnotagree_txt" onkeyup="buttonnotagree_txt();" onblur="buttonnotagree_txt();" ></td>
       <td><label>Agree Destination URL</label></td>
    <td><input type="text" value="" maxlength="90" id="buttonagree_txt" onkeyup="buttonagree_txt();" onblur="buttonagree_txt();" ></td>
   </tr>
...
{
	var layer1_txt=$("#ulp-layer-368").html();
	var layer2_txt=$("#ulp-layer-370").text();
	var button1_txt=$("#ulp-layer-371 a").text();

	var button2_txt=$("#ulp-layer-372 a").text();
...
var button1_href=$("#ulp-layer-371 a").attr("href");
var button2_href=$("#ulp-layer-372 a").attr("href");

$("#buttonnotagree_txt").val(button1_href);
$("#buttonagree_txt").val(button2_href);
                        ...
                        function popup_bg()
						{
							...
							//alert(bgcolor);
							$("#ulp-layer-366").css("background-color",popbgcolor);
						}
						function footer_bg()
						{
							var bkgcolor="#"+$("#bkgcolor").val();
							//alert(bgcolor);
							$("#ulp-layer-367").css("background-color",bkgcolor);
						}
						function layer1_color()
						{
							var fcolor="#"+$("#layer1_color").val();
							//alert(bgcolor);
							$("#ulp-layer-368").css("color",fcolor);
						}
					    ...
					    function layer1_txt()
						{
							...
							//alert(bgcolor);
							$("#ulp-layer-368").html(layer1_txt);
						}
					    function layer2_color()
						{
							var fcolor="#"+$("#layer2_color").val();
							//alert(bgcolor);
							$("#ulp-layer-370").css("color",fcolor);
						}
						...
						function button1_color()
						{
							...
							$("#ulp-layer-371 .ulp-link-button-red").css("color",fcolor);
                                                       $("#spnid").css("color",fcolor);
						}
						function button1_bkgcolor()
						{
							var button1_bkgcolor="#"+$("#button1_bkgcolor").val();
							$("#ulp-layer-371 .ulp-link-button-red").css('background',button1_bkgcolor);
						...
						function button1_txt()
						{
							...
							//alert(bgcolor);
							$("#ulp-layer-371 .ulp-link-button-red span").html(button1_txt);
						}
						...
						function button2_color()
						{
							...
							//alert(bgcolor);
							$("#ulp-layer-372 .ulp-link-button-green").css("color",fcolor);
						}
						function button2_bkgcolor()
						{
							var button2_bkgcolor="#"+$("#button2_bkgcolor").val();
							//alert(button1_bkgcolor);
							$("#ulp-layer-372 .ulp-link-button-green").css('background',button2_bkgcolor);
						}
						...
						function button2_txt()
						{
							...
							//alert(bgcolor);
							$("#ulp-layer-372 .ulp-link-button-green").html(button2_txt);
						}
						function buttonnotagree_txt()
						{
							var button1_href=$("#buttonnotagree_txt").val();
							//alert(bgcolor);
							$("#ulp-layer-371 .ulp-link-button-red").attr("href",button1_href);
						}
						function buttonagree_txt()
						{
							var button2_href=$("#buttonagree_txt").val();
							//alert(bgcolor);
							$("#ulp-layer-372 a").attr("href",button2_href);
						}
